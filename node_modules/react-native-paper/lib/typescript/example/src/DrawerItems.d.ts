...
declare const _default: (import("react").ComponentClass<Pick<Props, "isRTL" | "toggleTheme" | "toggleRTL" | "isDarkTheme"> & {
    theme?: import("@callstack/react-theme-provider").$DeepPartial<import("../../src/types").Theme> | undefined;
}, any> & import("@callstack/react-theme-provider/typings/hoist-non-react-statics").NonReactStatics<(import("react").ComponentClass<Props, any> & typeof DrawerItems) | (import("react").FunctionComponent<Props> & typeof DrawerItems), {}>) | (import("react").FunctionComponent<Pick<Props, "isRTL" | "toggleTheme" | "toggleRTL" | "isDarkTheme"> & {
    theme?: import("@callstack/react-theme-provider").$DeepPartial<import("../../src/types").Theme> | undefined;
